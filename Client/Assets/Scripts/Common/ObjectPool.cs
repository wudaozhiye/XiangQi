...
{
    private static readonly ObjectPoolImpl<Dictionary<TKey, TValue>> _dictionaryPool =
        new ObjectPoolImpl<Dictionary<TKey, TValue>>(null, l => l.Clear());
...
{
    private static readonly ObjectPoolImpl<LinkedList<T>> _listPool =
        new ObjectPoolImpl<LinkedList<T>>(null, l => l.Clear());
...
public class ObjectPool<T> where T : new()
{
    ...
    public static void Release(T element)
    {
        ...
        {
            Debug.LogError("ObjectPool Release: element already release to pool");
        }
