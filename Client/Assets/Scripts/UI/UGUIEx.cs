...
public static class UGUIEx
{
    ...
    public static void SetHighlightToNomalState(this Button button,bool is_highlight)
    {
        ...
        UIButtonHighlight c = button.GetComponent<UIButtonHighlight>();
        if (c == null)
        {
            c = button.gameObject.AddComponent<UIButtonHighlight>();
        }
    ...
    public static void onClick(this Image image, System.Action<Image> OnClick)
    {
        ...
        UIElementClickEvent ui_event = image.gameObject.GetComponent<UIElementClickEvent>();
        if (ui_event == null)
        {
            ui_event = image.gameObject.AddComponent<UIElementClickEvent>();
        }
