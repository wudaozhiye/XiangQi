...
public class AssetLoader : Singleton<AssetLoader>
{
    ...
    /// <summary>
    /// 返回模块的ABConfig配置文件的路径
    /// </summary>
    /// <param name="baseOrUpdate">只读路径还是热更路径</param>
    /// <param name="moduleName">模块名字</param>
    /// <param name="bundleName">ABConfig配置文件的名字</param>
    /// <returns></returns>
    private string ABConfigPath(BaseOrUpdate baseOrUpdate, string moduleName, string bundleName)
    {
        if (baseOrUpdate == BaseOrUpdate.Update)
        {
            return Application.persistentDataPath + "/Bundles/" + moduleName + "/" + bundleName;
        ...
        else
        {
            ...
            return Application.streamingAssetsPath + "/" + moduleName + "/" + bundleName;
#else
            return "file://" + Application.streamingAssetsPath + "/" + moduleName + "/" + bundleName;
#endif
        }
    }
    ...
    {
        string url = ABConfigPath(baseOrUpdate, moduleName, bundleConfigName);
